...
//		sesion.setAttribute("e", "asd");
		...
		if(action.equals("off")) {
			...
			return Response.ok().cookie(new NewCookie("korisnik", "-1")).build();
		}
		...
		if(korisnik == null) {
			...
			return Response.ok().cookie(new NewCookie("korisnik", korisnik.getEmail())).build(); //TODO send type of user
		}
